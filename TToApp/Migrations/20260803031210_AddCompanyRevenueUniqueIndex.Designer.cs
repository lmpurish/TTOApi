...
namespace TToApp.Migrations
{
    ...
    [Migration("20260803031210_AddCompanyRevenueUniqueIndex")]
    partial class AddCompanyRevenueUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TToApp.Model.CommunicationRecipientRule", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "WarehouseId", "EventType", "Channel", "Role")
                        .IsUnique()
            ...
            modelBuilder.Entity("TToApp.Model.CompanyRevenue", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "PayPeriodId", "WarehouseId", "RevenueType")
                        .IsUnique()
                        .HasFilter("[WarehouseId] IS NOT NULL");
            ...
            modelBuilder.Entity("TToApp.Model.ZonePayRule", b =>
                {
                    ...
                    b.Property<int?>("MinPackages")
                        .HasColumnType("int");

                    b.Property<int>("PaymentType")
                        .HasColumnType("int");

                    b.Property<bool>("UseDriverRateForExtra")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TToApp.Model.RentalRenter", b =>
                {
                    b.HasOne("User", "User")
                        .WithOne("RentalRenterProfile")
                        .HasForeignKey("TToApp.Model.RentalRenter", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("TToApp.Model.VehicleRental", b =>
                {
                    b.HasOne("TToApp.Model.RentalRenter", "RentalRenter")
                        .WithMany("VehicleRentals")
                        .HasForeignKey("RentalRenterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TToApp.Model.RentalVehicle", "RentalVehicle")
                        .WithMany("Rentals")
                        .HasForeignKey("RentalVehicleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("RentalRenter");
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.Navigation("RentalRenterProfile");
